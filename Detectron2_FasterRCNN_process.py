...
# --------------------
class Detectron2_FasterRCNNParam(core.CProtocolTaskParam):
...
# --------------------
class Detectron2_FasterRCNNProcess(dataprocess.CImageProcess2d):
...
# --------------------
class Detectron2_FasterRCNNProcessFactory(dataprocess.CProcessFactory):
